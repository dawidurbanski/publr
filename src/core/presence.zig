...
test "core presence: public API coverage" {
    _ = init;
    _ = setTiming;
    _ = setHeartbeatStaleSeconds;
    _ = getLockTimeoutMs;
    _ = getHeartbeatIntervalMs;
    _ = subscribe;
    _ = unsubscribe;
    _ = disconnect;
    _ = setActivity;
    ...
    _ = fieldEdit;
    _ = getConnEntryId;
    _ = checkTakeoverAllowed;
    _ = registerTakeover;
    _ = checkOwnershipOverride;
    _ = clearOwnershipOverrides;
    _ = notifyLockAcquired;
    _ = notifyLocksReleased;
    _ = broadcastEntryMessage;
}
