...
/// Delete a term and all descendant terms (cascades to media_terms associations).
...
test "taxonomy: public API coverage" {
    _ = createTerm;
    _ = listTerms;
    _ = renameTerm;
    _ = deleteTerm;
    _ = moveTermParent;
    _ = deleteTermWithReparent;
    _ = termExists;
    _ = getDescendantFolderIds;
    _ = syncMediaTerms;
    _ = addTermToMedia;
    _ = removeTermFromMedia;
    _ = replaceMediaFolder;
    _ = getMediaTermIds;
    _ = getMediaTermNames;
    _ = countMediaInTerm;
    _ = countMediaInFolderRecursive;
    _ = slugify;
}
