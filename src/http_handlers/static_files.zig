...
const PublrReferenceFieldJs = static.Asset("publr-reference-field.js", publr_ui.reference_field_js);
...
const asset_map = .{
    ...
    .{ "scripts/publr-reference-field.js", AssetEntry{ .asset = PublrReferenceFieldJs, .disk_path = null } },
