...
pub fn build(b: *std.Build) void {
    ...
    const static_files = .{
        ...
        .{ "static_kv_picker_js", "static/scripts/kv-picker.js" },
        .{ "static_presence_js", "static/scripts/presence.js" },
        .{ "static_publr_admin_js", "static/scripts/publr-admin.js" },
        .{ "static_repeater_js", "static/scripts/repeater.js" },
        .{ "static_shell_js", "static/scripts/shell.js" },
        .{ "static_media_library_js", "static/scripts/media-library.js" },
        .{ "static_media_picker_js", "static/scripts/media-picker.js" },
        .{ "static_media_edit_js", "static/scripts/media-edit.js" },
        .{ "static_image_field_js", "static/scripts/image-field.js" },
        .{ "static_kv_filter_js", "static/scripts/kv-filter.js" },
        .{ "static_version_compare_js", "static/scripts/version-compare.js" },
        .{ "static_content_list_js", "static/scripts/content-list.js" },
        .{ "static_recompile_bar_js", "static/scripts/recompile-bar.js" },
        .{ "static_entry_editor_js", "static/scripts/entry-editor.js" },
        .{ "static_ws_js", "static/scripts/ws.js" },
        // PublrJS runtime (data-p-* stores) — drives the shell, query, the
        // DS-built publr-*.js components, and every app store above. The
        // legacy interact/ runtime is fully retired (epic #462).
